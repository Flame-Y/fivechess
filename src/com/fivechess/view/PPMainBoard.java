...
public class PPMainBoard extends MainBoard {
    ...
    public void init() {
        ...
        giveUp.setFont(new Font("宋体", Font.BOLD, 20));
        ...
        people1.setBounds(10, 350, 200, 50);
        ...
        jLabel2 = new JLabel();
        add(jLabel2);
        jLabel2.setBounds(130, 350, 200, 50);
        timecount = new JLabel("    计时器:");
        timecount.setBounds(320, 1, 200, 50);
        timecount.setFont(new Font("宋体", Font.BOLD, 30));
